...
const MerchantGargaAccount: React.FC<MerchantGargaAccountProps> = ({
  isOpen,
  onClose,
}) => {
  ...
  const [accounts, setAccounts] = useState<MerchantGargaAccountData[]>([]);
  ...
  // Handle edit account
  const handleEdit = (account: MerchantGargaAccountData) => {
  ...
  const handleDelete = (account: MerchantGargaAccountData) => {
          ...
          <div className="flex items-center space-x-4 space-x-reverse text-right">
            ...
            <div>
              ...
              <DialogDescription className="text-gray-400 text-right">
                إدارة حسابات تجار جرجا والفواتير
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
                ...
                >
                  ...
                  >
                    ...
                    <Textarea
                      ...
                      className="bg-gray-700/50 border-gray-600/50 text-white focus:ring-emerald-500 focus:border-emerald-500 text-right min-h-[80px]"
                      rows={3}
                    />
                  </motion.div>
                  ...
                  >
                    <div className="p-4 bg-gradient-to-r from-emerald-600/20 to-teal-600/20 border border-emerald-500/30 rounded-lg">
