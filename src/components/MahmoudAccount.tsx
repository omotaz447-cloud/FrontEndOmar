...
interface MahmoudAccountProps {
  isOpen: boolean;
  onClose: () => void;
}

const MahmoudAccount: React.FC<MahmoudAccountProps> = ({
  isOpen,
  onClose,
}) => {
  ...
  const [formData, setFormData] = useState<MahmoudAccountData>({
    cash: 0,
    blessing: 0,
    withdrawal: 0,
    date: '',
  ...
  const [accounts, setAccounts] = useState<MahmoudAccountData[]>([]);
  const [isLoading, setIsLoading] = useState(false);
  const [isSubmitting, setIsSubmitting] = useState(false);
  const [selectedDate, setSelectedDate] = useState<Date>();
  const [calendarOpen, setCalendarOpen] = useState(false);
  const [editingAccount, setEditingAccount] = useState<MahmoudAccountData | null>(null);

  // Edit/Delete dialog states
  const [editDialogOpen, setEditDialogOpen] = useState(false);
  const [editFormData, setEditFormData] = useState<MahmoudAccountData>({
    cash: 0,
    blessing: 0,
    withdrawal: 0,
    date: '',
  ...
  const [deleteAccount, setDeleteAccount] = useState<MahmoudAccountData | null>(null);
  ...
  const handleEdit = (account: MahmoudAccountData) => {
  ...
  const handleDelete = (account: MahmoudAccountData) => {
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-black border-gray-700/50 p-0">
        ...
        <DialogHeader className="relative z-10 p-6 border-b border-gray-700/50">
          <div className="flex items-center space-x-4 space-x-reverse text-right">
            <motion.div
              className="p-3 bg-gradient-to-r from-purple-600 to-indigo-700 rounded-xl"
            ...
            <Card className="bg-gray-800/40 border-gray-700/30 mb-6">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400 text-right">
                  {editingAccount ? 'تعديل بيانات حساب محمود موهوب' : 'أدخل بيانات حساب محمود موهوب'}
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form
                ...
                >
                  ...
                  >
                    <div className="p-4 bg-gradient-to-r from-purple-600/20 to-indigo-600/20 border border-purple-500/30 rounded-lg">
                      <div className="flex items-center justify-between">
                        <span className="text-purple-300 font-semibold text-lg">الإجمالي المحسوب:</span>
                  ...
                  >
                    ...
                    <Button
                      ...
                      className="bg-gradient-to-r from-purple-600 to-indigo-700 hover:from-purple-700 hover:to-indigo-800 text-white px-8 py-3 rounded-xl font-medium transition-all duration-200 shadow-lg hover:shadow-purple-500/25"
                    >
                      {isSubmitting ? (
                        <>
            ...
            <CardHeader className="border-b border-gray-700/30">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3 space-x-reverse">
                  <motion.div
                    className="p-2 bg-gradient-to-r from-purple-600 to-indigo-700 rounded-lg"
                    whileHover={{ scale: 1.05 }}
                  >
              ...
              <CardDescription className="text-gray-400 text-right">
                جميع سجلات حسابات محمود موهوب البلينا
              </CardDescription>
            </CardHeader>
          ...
          <div className="overflow-y-auto max-h-[calc(90vh-200px)] p-6">
            <form onSubmit={handleEditSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                <div className="p-4 bg-gradient-to-r from-blue-600/20 to-indigo-600/20 border border-blue-500/30 rounded-lg">
                  <div className="flex items-center justify-between">
                    <span className="text-blue-300 font-semibold text-lg">الإجمالي:</span>
        ...
        <AlertDialogContent className="bg-gray-900 border-gray-700 text-white">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-gray-300 text-right">
              هل أنت متأكد من حذف سجل محمود محب لتاريخ "{deleteAccount?.date}"؟
              <br />
