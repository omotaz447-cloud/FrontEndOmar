...
//                 <Label htmlFor="day" className="text-white font-medium">
//                   اليوم
//                 </Label>
//                 <div className="relative">
//                   <CalendarIcon className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5 z-10" />
//                   <Select
//                     value={formData.day}
//                     onValueChange={(value) => setFormData(prev => ({ ...prev, day: value }))}
//                   >
//                     <SelectTrigger className="bg-gray-800 border-gray-600 text-white pr-12 focus:border-emerald-500">
...
//               {/* Rent */}
//               <div className="space-y-2">
//                 <Label htmlFor="rent" className="text-white font-medium">
//                   الايجار
//                 </Label>
//                 <div className="relative">
...
//                     className="bg-gray-800 border-gray-600 text-white pr-12 focus:border-emerald-500"
...
//               {/* Expenses */}
//               <div className="space-y-2">
//                 <Label htmlFor="expenses" className="text-white font-medium">
//                   المصاريف
//                 </Label>
//                 <div className="relative">
//                   <TrendingDown className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5" />
//                   <Input
//                     id="expenses"
//                     name="expenses"
//                     type="number"
...
//               {/* Sold */}
//               <div className="space-y-2">
//                 <Label htmlFor="sold" className="text-white font-medium">
//                   المباع
//                 </Label>
//                 <div className="relative">
...
//               {/* Exit Name */}
//               <div className="space-y-2">
//                 <Label htmlFor="exitName" className="text-white font-medium">
//                   اسم الخارج
//                 </Label>
//                 <div className="relative">
...
//               {/* Exits */}
//               <div className="space-y-2">
//                 <Label htmlFor="exits" className="text-white font-medium">
//                   الخوارج
//                 </Label>
//                 <div className="relative">
//                   <TrendingDown className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5" />
...
//                 <Card className="bg-gradient-to-r from-emerald-600 via-green-700 to-teal-800 border-emerald-500">
...
//                         (المباع - الإيجار - المصاريف - الخوارج)
//                       </div>
//                     </div>
//                   </CardContent>
//                 </Card>
...
//                   onChange={handleInputChange}
//                   className="bg-gray-800 border-gray-600 text-white pr-12 focus:border-emerald-500 min-h-[100px]"
...
//                     <p className="text-gray-400 text-lg">لا توجد سجلات مبيعات</p>
//                     <p className="text-gray-500 text-sm mt-2">قم بإضافة مبيعات جديدة للبدء</p>
//                   </div>
//                 ) : (
...
//                               <TableHead className="text-gray-300 font-semibold text-right text-xs sm:text-sm px-2 sm:px-4 py-2 sm:py-3">اليوم</TableHead>
//                               <TableHead className="text-gray-300 font-semibold text-right text-xs sm:text-sm px-2 sm:px-4 py-2 sm:py-3">التاريخ</TableHead>
//                               <TableHead className="text-gray-300 font-semibold text-right text-xs sm:text-sm px-2 sm:px-4 py-2 sm:py-3">الإيجار</TableHead>
//                               <TableHead className="text-gray-300 font-semibold text-right text-xs sm:text-sm px-2 sm:px-4 py-2 sm:py-3">المصاريف</TableHead>
//                               <TableHead className="text-gray-300 font-semibold text-right text-xs sm:text-sm px-2 sm:px-4 py-2 sm:py-3">المباع</TableHead>
//                               <TableHead className="text-gray-300 font-semibold text-right text-xs sm:text-sm px-2 sm:px-4 py-2 sm:py-3">اسم الخارج</TableHead>
//                               <TableHead className="text-gray-300 font-semibold text-right text-xs sm:text-sm px-2 sm:px-4 py-2 sm:py-3">الخوارج</TableHead>
//                               <TableHead className="text-gray-300 font-semibold text-right text-xs sm:text-sm px-2 sm:px-4 py-2 sm:py-3">الإجمالي</TableHead>
//                               <TableHead className="text-gray-300 font-semibold text-right text-xs sm:text-sm px-2 sm:px-4 py-2 sm:py-3">ملاحظات</TableHead>
...
//                             </TableCell>
//                             <TableCell className="text-gray-300 text-right">
//                               {sale.rent.toLocaleString('ar-EG')} جنيه
//                             </TableCell>
//                             <TableCell className="text-gray-300 text-right">
//                               {sale.expenses.toLocaleString('ar-EG')} جنيه
//                             </TableCell>
//                             <TableCell className="text-gray-300 text-right">
//                               {sale.sold.toLocaleString('ar-EG')} جنيه
//                             </TableCell>
//                             <TableCell className="text-gray-300 text-right">{sale.exitName}</TableCell>
//                             <TableCell className="text-gray-300 text-right">
//                               {sale.exits.toLocaleString('ar-EG')} جنيه
//                             </TableCell>
//                             <TableCell className="text-emerald-400 font-semibold text-right">
//                               {((sale.sold - sale.rent - sale.expenses - sale.exits)).toLocaleString('ar-EG')} جنيه
//                             </TableCell>
...
//           <div className="flex justify-center pt-4 sm:pt-6 px-4 sm:px-6 pb-4 sm:pb-6 border-t border-gray-700/50 flex-shrink-0">
//             <Button
//               variant="outline"
//               onClick={onClose}
...
//         <DialogContent className="max-w-6xl max-h-[90vh] overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-black border-gray-700/50">
...
//                       onValueChange={(value) => setEditFormData(prev => ({ ...prev, day: value }))}
//                     >
//                       <SelectTrigger className="bg-gray-800 border-gray-600 text-white pr-12 focus:border-emerald-500">
//                         <SelectValue placeholder="اختر اليوم" />
//                       </SelectTrigger>
...
//                 {/* Rent */}
//                 <div className="space-y-2">
//                   <Label htmlFor="edit-rent" className="text-white font-medium">
//                     الايجار
//                   </Label>
//                   <div className="relative">
//                     <DollarSign className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5" />
...
//                 {/* Expenses */}
//                 <div className="space-y-2">
//                   <Label htmlFor="edit-expenses" className="text-white font-medium">
//                     المصاريف
//                   </Label>
//                   <div className="relative">
//                     <TrendingDown className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5" />
...
//                 {/* Sold */}
//                 <div className="space-y-2">
//                   <Label htmlFor="edit-sold" className="text-white font-medium">
//                     المباع
//                   </Label>
//                   <div className="relative">
//                     <TrendingUp className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5" />
...
//                 {/* Exit Name */}
//                 <div className="space-y-2">
//                   <Label htmlFor="edit-exitName" className="text-white font-medium">
//                     اسم الخارج
//                   </Label>
//                   <div className="relative">
//                     <User className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5" />
...
//                 {/* Exits */}
//                 <div className="space-y-2">
//                   <Label htmlFor="edit-exits" className="text-white font-medium">
//                     الخوارج
//                   </Label>
//                   <div className="relative">
//                     <TrendingDown className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5" />
